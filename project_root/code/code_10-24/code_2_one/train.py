...
file, file_len = data_utils.get_data(args.filename,args.chunk_len * 2,args.predict_length)
...
try:
    ...
    for my_str in predict_data:
        res = generate(decoder,prime_str = my_str[:-1],predict_len=1,cuda=True)
        print(res)
        print(my_str)
    ...
    save_file = 'save/'+args.filename[12:-4]+'.json'
