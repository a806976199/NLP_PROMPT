...
#            head = head[:-1]
    ...
    os.remove("test.csv")
    import shutil
    pwd='/home/ckj/file/temp-experience/git-experience/tool/machine_learning/my_process/T5_model/my_test/time_series_template/func_time/k-linear/prompt_9-16'
...
sum = 0
for struct_num in range(25,27,2):
     for functions in all_functions:
         for read_file in all_file:
             ...
             with open(read_file, newline='') as csvfile:
                 ...
                 numbers = len(list(reader))
             # print(read_file,numbers)
             generate_data(int(struct_num),int(4),numbers,functions,"test"+str(sum),read_file)
