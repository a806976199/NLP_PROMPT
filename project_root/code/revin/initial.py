...
#                outputs.append(str(y_revin[-1])[1:-1])
                outputs.append(y_revin)
            # with open('res_x.json','w') as json_file:
            #         json.dump(inputs,json_file,indent=4)
            #         json_file.write('\n')
            # with open('res_y.json','w') as json_file:
...
#            print(i)
    ...
    os.remove("test.csv")
    import shutil
    pwd= '/home/ckj/file/temp-experience/git-experience/tool/machine_learning/my_process/T5_model/my_test/time_series_template/func_time/revin'
...
#for struct_num in range(16,20,4):
