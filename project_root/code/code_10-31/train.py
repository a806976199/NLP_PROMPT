...
argparser.add_argument('--predict_length', type=int, default=1)
...
#all_file = sorted(all_file)[:3]
file, file_len = data_utils.get_datas(all_file,args.chunk_len,args.predict_length)


# for num in range(0,file_len):
#     history = file[num][:25]
#     pred = file[num][-3:]
#     data_utils.res = []
#     data_utils.func_history(history)
#     history = data_utils.res[::-1]
#     history = [0] * (25 - len(history)) + history
#     pred = [data_utils.three_char(pred[0],pred[1],pred[2])]
#     file[num] = history + pred
#     print(file[num])
