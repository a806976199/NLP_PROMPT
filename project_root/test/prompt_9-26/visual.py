...
# 示例数据
def get_pic_chatglm(data_file,num,lstm_file):
...
files = ["lstm_data/AGR.json","lstm_data/AMD.json","lstm_data/BAH.json","lstm_data/BKR.json","lstm_data/IBTD.json","lstm_data/IGF.json"]
for file in files:
    print(file,":",get_pic_lstm(file,40))

# print(files[1],":",get_pic_lstm(files[1],40))
