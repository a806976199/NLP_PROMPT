...
#file_pattern = "json/save_3_char_total/*.json"
file_pattern = "json/save_3_char_one/*.json"
#file_pattern = "json/save_2_char_total/*.json"
#file_pattern = "json/save_2_char_one/*.json"
lstm_file = []
for file_name in glob.glob(file_pattern):
    lstm_file.append(file_name)
...
for file in lstm_file:
    ...
    print(lstm_correct)
#save_file = "3_char_total.json"
save_file = "3_char_one.json"
#save_file = "2_char_total.json"
#save_file = "2_char_one.json"
lstm_correct['mse'] = average_lstm_correct / len(lstm_file)
