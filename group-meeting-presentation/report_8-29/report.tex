...
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/initial.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/output.png}            
        }
    \end{figure}
\end{frame}

\subsection{测试集预测结果可视化}
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/no_revin.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/after_decode.png}
        }
    \end{figure}
\end{frame}


\subsection{对未见过多项式函数数据集进行预测,并计算预测误差}
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/png/linear-initial.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/png/linear-result.png}
        }
    \end{figure}
\end{frame}

\subsection{对多项式函数预测结果可视化}
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/linear-initial.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/linear-result.png}
        }
    \end{figure}
\end{frame}


\subsection{对未见过\ff{tan(x)}三角函数数据集进行预测,并计算预测误差}
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/png/tan-initial.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/png/tan-result.png}
        }
    \end{figure}
\end{frame}

\subsection{对\ff{tan(x)}预测结果可视化}
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/tan-initial.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/tan-result.png}
        }
    \end{figure}
\end{frame}

\subsection{未解码之前的，多项式函数和\ff{tan(x)}之间的走势对比图}
\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[\tiny 未用RevIN的测试结果，pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/linear_before_decode.png}
        }
        \hfill
        \subfigure[\tiny RevIN的测试结果,pass:100\%]{
            \includegraphics[width=0.45\textwidth]{png/compare_png/tan_before_decode.png}
        }
    \end{figure}
\end{frame}

\begin{frame}
	\frametitle{Revin泛化性相关结论}
	\begin{itemize}
        \item 经过revin处理后，在面对为见过的任务上，误差明显小于未经过revin处理的结果，不管是在周期函数还是在线性函数上均表现一致。
        \item 不管是周期函数和单调函数，语言模型预测走势都和真实走趋基本一致
        \eee{
            \item 对于见过的任务能够保证走势基本一致
            \item 对于未见过的任务能够在真实走势上下浮动，偶尔有个别点出现大幅度偏离
        }
	\end{itemize}
\end{frame}
...
\end{frame}
\subsection*{对50只股票数据进行训练，每只股票的长度是2300天左右}

\begin{frame}
    % \frametitle{\tiny 测试集的结果预测}    
    \begin{figure}[ht]
        \centering
        \subfigure[ 预测准确率:58.06\%]{
            \includegraphics[width=0.45\textwidth]{png/1.png}
        }
        \hfill
        \subfigure[ 预测准确率:58.06\%]{
            \includegraphics[width=0.45\textwidth]{png/02.png}
        }
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}[ht]
        \centering
        \subfigure[ 预测准确率:58.06\%]{
            \includegraphics[width=0.45\textwidth]{png/03.png}
        }
        \hfill
        \subfigure[ 预测准确率:58.06\%]{
            \includegraphics[width=0.45\textwidth]{png/04.png}
        }
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}[ht]
        \centering
        \subfigure[ 预测准确率:48.39\%]{
            \includegraphics[width=0.45\textwidth]{png/05.png}
        }
        \hfill
        \subfigure[ 预测准确率:57.26\%]{
            \includegraphics[width=0.45\textwidth]{png/06.png}
        }
    \end{figure}
\end{frame}
